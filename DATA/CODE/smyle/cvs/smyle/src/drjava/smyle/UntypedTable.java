...
/** A data table in a Smyle store; generic, typeless variant.
    Not for use in normal applications, but rather in universal db tools
    */
public interface UntypedTable {
